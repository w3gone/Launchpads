...
/**
 * @dev The official MOONPETS smart contract
 */
contract MOONPETS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "MOONPETS (MOONPETS.ORG)";
    string private _symbol   = "MOONPETS";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for MOONPETS/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x8D2DC8B97FB3981836ad279fD14Be84aFFDbE1Dd); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion MOONPETS will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-MOONPETS tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts MOONPETS balance for buybacks, Farming, liquidity and marketing
    ...
    /**
     * @notice Burns MOONPETS tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of MOONPETS tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from MOONPETS)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of MOONPETS
            path,
